...
void CxShadeButton::SetOff()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"Off");
	SetTextColor(RGB(255,0,0));
}

void CxShadeButton::SetOn()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"On");
...
void CxShadeButton::SetSystem()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"System");
	SetTextColor(RGB(0,0,0));
}

void CxShadeButton::SetRclk()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"Rclk");
	SetTextColor(RGB(0,0,0));
}

void CxShadeButton::SetMaster()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"Master");
	SetTextColor(RGB(0,0,0));
}

void CxShadeButton::SetSlave()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"Slave");
	SetTextColor(RGB(0,0,0));
}

void CxShadeButton::SetEnabled()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"Enabled");
	SetTextColor(RGB(0,0,0));
}

void CxShadeButton::SetDisabled()
{
	SetShade(3,20,50,100,RGB(200,200,200));
	SetWindowText(L"Disabled");
	SetTextColor(RGB(255,0,0));
}

void CxShadeButton::SetParam()
{
//SetShade(3,20,50,100,RGB(200,200,200));

//SetShade(3,80,80,150,RGB(200,200,200));

SetShade(SHS_DIAGSHADE,8,50,5,RGB(75,255,255));


}

void CxShadeButton::SetCheck()
{
SetShade(3,8,40,90,RGB(255,255,5));
}

void CxShadeButton::SetRed()
{
SetShade(3,8,40,90,RGB(255,5,5));
}

xShadeButton::xShadeButton(void)
{
}
